//palvras
const animais = [
    "leao", "elefante", "girafa", "tigre", "panda", "macaco", "gato", "cachorro", "zebra", "hiena",
    "pinguim", "koala", "iguana", "papagaio", "baleia", "peixe", "cobra", "tartaruga", "lagarto", "sapo",
    "coruja", "avestruz", "caracol", "leopardo", "camelo", "rinoceronte", "hipopotamo", "esquilo", "suricate",
    "corvo", "foca", "morsa", "orangotango", "coala", "arara", "morcego", "escorpiao", "tucano", "tubarao",
    "peixeboi", "golfinho", "ourico", "guaxinim", "lontra", "ariranha", "beijaflor", "mandril", "vaca", "ovelha",
    "abelha", "formiga"
];


//variaveis
let palavraSecreta = animais[Math.floor(Math.random() * animais.length)];
const letrasErradas = [];
