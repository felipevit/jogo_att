//palvras
const cores = [
    "vermelho", "azul", "verde", "amarelo", "laranja", "roxo", "rosa", "preto", "branco", "marrom",
    "cinza", "dourado", "prateado", "violeta", "turquesa", "creme", "oliva", "azulmarinho", "pessego",
    "lavanda", "rosachoque", "terracota", "azulceleste", "ciano", "ametista", "lima", "ambar", "cereja",
    "açafrao", "esmeralda", "safira", "indigo", "marfim", "mauve", "topazio", "taupe", "khaki","tomato",
    "chartreuse", "magenta", "maroon", "salmon", "navy", "teal", "coral", "bege", "verde-oliva", "terra"
];


//variaveis
let palavraSecreta = cores[Math.floor(Math.random() * cores.length)];
const letrasErradas = [];
